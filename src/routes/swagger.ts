 ...
 *         phoneNumber:
 *           type: string
 *           description: Белорусский номер телефона (обязательно, международный или внутренний формат)
 *           example: "+375291234567"
 *           pattern: "^(\\+375|8)((25|29|33|44)\\d{7}|(17|162|212|232|152|222)\\d{6,7})$"
 *         message:
 *           type: string
 ...
 *             example4:
 *               summary: Пример с внутренним мобильным номером
 *               value:
 *                 phoneNumber: "80291234567"
 *                 message: "Тестовое сообщение для внутреннего формата"
 *             example5:
 *               summary: Пример с внутренним стационарным номером
 *               value:
 *                 phoneNumber: "80171234567"
 *                 message: "Тестовое сообщение для внутреннего стационарного номера"
 *     responses:
 *       201:
